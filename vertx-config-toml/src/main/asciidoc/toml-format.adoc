...
The TOML Configuration Format extends the Vert.x Configuration Retriever and provides the
support for the TOML Configuration Format format.
...
compile 'io.vertx:vertx-config-toml:${maven.version}'
----
